...
/** @type {string} */
const CACHE_VERSION = '1779337229|696244775';
/** @type {string} */
const CACHE_PREFIX = 'RealPlate-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'RealPlate.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["RealPlate.html","RealPlate.js","RealPlate.offline.html","RealPlate.icon.png","RealPlate.apple-touch-icon.png","RealPlate.audio.worklet.js","RealPlate.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["RealPlate.wasm","RealPlate.pck"];
